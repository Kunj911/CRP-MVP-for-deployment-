...
async function main() {
  ...
  console.log(JSON.stringify(deps.data.deployments[0], null, 2));
  ...
  const svc = await gql(svcQuery, { sid: BACKEND_SERVICE });
  console.log('\\nService config:');
  console.log(JSON.stringify(svc.data.service, null, 2));
}
